...
export const Projects = () => {
  ...
  const rawData = [
    ...
    { id: "portfolio",      image: "./giuliprofile.jpeg",   liveUrl: "https://dev.giulianadirocco.com",           githubUrl: "https://github.com/giuliannadr/portfolio-giuliana", type: "professional", stack: ["React 18", "TypeScript", "Vite", "Framer Motion", "react-i18next", "Firebase Firestore", "Vercel", "SEO técnico"] },
