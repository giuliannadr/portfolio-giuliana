...
export const Projects = () => {
  ...
  const rawData = [
    ...
    { id: "costear",        image: "./costear-mockup.png",   githubUrl: "https://github.com/giuliannadr/CosteAR-backend",                    type: "professional", inProgress: true, stack: ["Node.js", "WhatsApp API", "React", "TypeScript", "REST APIs", "Agro-industrial Analytics"] },
